...
class TimelineEventType(str, Enum):
    ...
    PARTICIPANT_ROLE_CORRECTED = "PARTICIPANT_ROLE_CORRECTED"
    AGORA_SESSION_STARTED = "AGORA_SESSION_STARTED"
    AGORA_SESSION_ENDED = "AGORA_SESSION_ENDED"
    AGORA_AGENT_JOINED = "AGORA_AGENT_JOINED"
    AGORA_AGENT_LEFT = "AGORA_AGENT_LEFT"
    AGORA_AGENT_ERROR = "AGORA_AGENT_ERROR"
    AGORA_SUMMARY_SPOKEN = "AGORA_SUMMARY_SPOKEN"
...
class AgoraSessionStatus(str, Enum):
    STARTING = "STARTING"
    ACTIVE = "ACTIVE"
    ENDED = "ENDED"
    FAILED = "FAILED"
